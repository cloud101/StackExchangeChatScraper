...
class Message(object):
    ...
    def jsonify(self):
        return {
            ...
            'owner_user_name': self.owner.name,
            'edits':self.edits,
            'edited': self.edited,
            'starred_by_you':self.starred_by_you,
            'parent_message_id': self._parent_message_id,
            'stars': self.stars,
            'editor_user_name':self.editor.name if self.editor else None,
            'editor_user_id': self.editor.id if self.editor else None,
            'pins':self.pins,
            'pinned':self.pinned,
            'starred':self.starred,
            'pinner_user_ids': [a.id for a in self.pinners],
            'pinner_user_names': [a.name for a in self.pinners]
        }
